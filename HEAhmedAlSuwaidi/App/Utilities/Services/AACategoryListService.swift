...
class AACategoryListService: NSObject {
    let categoryByYear  = "hea_json_articlesByyearlist.php?moduleid=2"
    let categoryByPlace = "hea_json_articlesByplacelist.php?moduleid=2"
    let categoryByNewspaper = "hea_json_articlesBynewspaperlist.php?moduleid=2"
    let categoryByCategory = "hea_json_articlesBycategorylist.php?moduleid=2"
